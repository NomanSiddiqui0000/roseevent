...
import { Calendar, Users, MapPin, DollarSign, Check, CheckCircle } from 'lucide-react';
          ...
          >
            ...
            <AnimatePresence mode="wait" custom={direction}>
              {!submitted ? (
                ...
                >
                  <CheckCircle size={56} className="mx-auto text-accent mb-4" />
                  <p className="font-serif text-3xl text-accent mb-2">Thank You!</p>
                  <p className="font-sans text-gray-600 mb-6">Our team will reach out within 24 hours.</p>
                  <button
                    type="button"
                    onClick={resetForm}
                    className="px-8 py-3 bg-accent/10 text-accent font-sans font-bold text-xs tracking-[1.5px] uppercase rounded-xl hover:bg-accent hover:text-white transition-all duration-300"
                  >
                    Plan Another Event
                  </button>
                </motion.div>
